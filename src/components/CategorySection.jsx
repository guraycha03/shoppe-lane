...
const categories = [
  ...
  { name: 'Men', image: `${import.meta.env.BASE_URL}images/categories/men.jpg`, path: '/category/kids' },
  { name: 'Kids', image: `${import.meta.env.BASE_URL}images/categories/kids.jpg`, path: '/category/lifestyle' },
  { name: 'Essentials', image: `${import.meta.env.BASE_URL}images/categories/essentials.jpg`, path: '/essentials' },
  { name: 'Beauty', image: `${import.meta.env.BASE_URL}images/categories/beauty.jpg`, path: '/category/men' },
  ...
  { name: 'Lifestyle', image: `${import.meta.env.BASE_URL}images/categories/lifestyle.jpg`, path: '/sale' },
  { name: 'Stationery', image: `${import.meta.env.BASE_URL}images/categories/stationary.jpg`, path: '/category/women' },
  { name: 'Gift Ideas', image: `${import.meta.env.BASE_URL}images/categories/gift_ideas.jpg`, path: '/sale' },
  { name: 'Office Supplies', image: `${import.meta.env.BASE_URL}images/categories/office_supplies.jpg`, path: '/category/women' },
];
